          ...
          {halls.length === 0 ? (
            ...
            halls.map((hall) => (
              <div key={hall.id} className="border p-4 rounded shadow">
                ...
                <button
                  className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 w-full focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:outline-none"
