    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 gap-8">
        <div>
          ...
          <button className="bg-green-600 text-white px-4 py-2 rounded mb-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2">+ Add New Hall</button>
